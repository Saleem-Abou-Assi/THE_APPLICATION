      ...
      <ScrollView className='flex-1 w-[100%] '>
        ...
        <View className='w-[100%] flex-1 flex-col gap-y-3 bg-white rounded-lg h-fit'>
          ...
          <View className='flex-1 flex-row max-h-8  justify-center'>
            <View className='w-[20%] items-center '><Text className='font-bold text-lg'> الاسم</Text></View>
            <View className='w-[20%] items-center'><Text className='font-bold text-lg'> الخط</Text></View>
            <View className='w-[20%] items-center'><Text className='font-bold text-lg'> الرصيد</Text></View>
 ...
 <ScrollView>
          {filteredItems.map((record) => (
            ...
            <View key={record.id} className='flex-1 flex-row gap-x-1 items-center justify-center max-h-10 my-2 '>
              ...
              <View className='w-[40%] flex-row gap-2 justify-center'>
              <View>
                <TouchableOpacity 
