...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Modal, TextInput, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, ActivityIndicator } from 'react-native';
                    ...
                    <body>
                        <div class="bill-container">
                            <div class="bill-header">
                                <h1>فاتورة #${billData.bill_out_id}</h1>
                                <p>تاريخ الإصدار: ${new Date().toLocaleDateString('ar')}</p>
                            </div>
                            <div class="bill-details">
                                <p>التاجر: ${selectedTrader?.name || ''}</p>
        ...
        <ScrollView className='flex-1 w-full overflow-y-scroll'>
                ...
                <View className='flex-1 w-[100%] items-center'>
                    <View className='w-[100%] bg-white shadow-slate-700 p-2 m-5 rounded-lg'>
                        ...
                        >
                            <Text className='text-white font-bold'>{selectedTrader ? selectedTrader.name : "اختر بائع"}</Text>
                        </TouchableOpacity>
                        </View>
                        ...
                        <TouchableOpacity 
                            ...
                            disabled={!selectedTraderId || selectedItems.length === 0 || printing}
                        >
                            {printing ? (
